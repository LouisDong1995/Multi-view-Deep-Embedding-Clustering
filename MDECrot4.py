...
class MDEC(object):
    ...
    def pretrain(self, x1, x2, x3, x4, batch_size=256, epochs=500, optimizer='adam', save_dir='results/temp', aug_pretrain=False, alpha=0.001):
        print('...Pretraining...')
        ...
        for ite in range(int(maxiter)):
            ...
            if (index + 1) * batch_size > x1.shape[0]:
                ...
                loss = self.model.train_on_batch(x=[x1[index * batch_size:(index + 1) * batch_size],
                                                    ...
                                                    x3[index * batch_size:(index + 1) * batch_size],
                                                    x4[index * batch_size:(index + 1) * batch_size]],
